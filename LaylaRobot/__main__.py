...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(
            text="ꜱᴜᴘᴘᴏʀᴛ", url=f"https://t.me/{alanwalkerbotsupport}"
        ),
    ],
    [
